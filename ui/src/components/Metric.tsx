...
const card: CSSProperties = {
  ...
  borderRadius: 10,
  background: 'var(--rpt-bg, #fff)',
}

const trendColor = (t?: string) =>
  t === 'up' ? '#059669' : t === 'down' ? '#e11d48' : '#6b7280'

export function Metric({ spec }: { spec: MetricSpec }) {
  return (
    <div style={card}>
      <span style={{ fontSize: 11, fontWeight: 700, textTransform: 'uppercase', letterSpacing: '0.05em', color: '#6b7280' }}>
